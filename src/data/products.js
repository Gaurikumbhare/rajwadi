const products = [
  {
    id: "prod-lehenga-01",
    name: "Royal Crimson & Gold Bridal Lehenga Choli",
    category: "Lehenga",
    price: 349.00,
    rating: 4.9,
    reviews: 42,
    ...
    color: "Red",
    fabric: "Velvet",
    description: "A spectacular royal red bridal lehenga crafted in premium velvet, adorned with heavy zari, stones, and dabka hand embroidery. Complete with a matching embroidered blouse and a sheer net dupatta.",
